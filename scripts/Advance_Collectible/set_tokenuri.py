...
def set_tokenURI(token_id, nft_contract, tokenURI):
    ...
    tx.wait(1)
    print(
        f"[+] NFT Uploaded, View NFT at {OPENSEA_URL.format(nft_contract.address, token_id)}"
    )
    print("[Note] Please wait up to 20 minutes, and hit the refresh metadata button")
